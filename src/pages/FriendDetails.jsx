...
const FriendDetails = () => {
  ...
  const handleCheckIn = (type) => {
    ...
    window.myGlobalTimeline = [newEntry, ...window.myGlobalTimeline];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 flex flex-col gap-4">
          ...
          <div className="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm flex flex-col divide-y divide-gray-50">
            <button onClick={() => toast("Snoozed 2 weeks")} className="py-4 px-6 flex items-center justify-center gap-3 hover:bg-gray-50 text-slate-700 font-bold text-sm transition">
              <BellSnoozeIcon className="w-5 h-5 text-slate-400" /> Snooze 2 Weeks
            </button>
            <button onClick={() => toast("Archived")} className="py-4 px-6 flex items-center justify-center gap-3 hover:bg-gray-50 text-slate-700 font-bold text-sm transition">
              <ArchiveBoxIcon className="w-5 h-5 text-slate-400" /> Archive
            </button>
            <button onClick={() => toast.error("Deleted")} className="py-4 px-6 flex items-center justify-center gap-3 hover:bg-red-50 text-[#EF4444] font-bold text-sm transition">
              <TrashIcon className="w-5 h-5 text-[#EF4444]/60" /> Delete
            </button>
          </div>
        </div>
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          ...
          <div className="bg-white p-8 rounded-xl border border-gray-100 flex justify-between items-center shadow-sm">
            ...
            <button onClick={() => toast("Edit goal coming soon")} className="px-4 py-2 bg-gray-50 border border-gray-100 text-slate-700 rounded-md hover:bg-gray-100 text-sm font-bold transition">
              Edit
            </button>
          </div>
